...
export default function CrearClientePosPage() {
      ...
      <div className="fade-up-element flex items-center justify-between mb-6 flex-shrink-0">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-sm text-gray-500 hidden sm:block">Registra un nuevo cliente para gestionar sus pedidos.</p>
          </div>
        </div>
      </div>
        ...
        <form onSubmit={handleSubmit} className="fade-up-element bg-white p-6 sm:p-8 rounded-3xl shadow-sm border border-gray-100 flex flex-col gap-6">
          ...
          <div className="space-y-2">
            ...
            <Input 
              ...
              className="h-12 rounded-xl border-gray-200 focus:border-brand-blue focus:ring-brand-blue/20"
              required
            />
          </div>
