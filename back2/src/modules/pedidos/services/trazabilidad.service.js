...
class TrazabilidadService {
    ...
    _validarTransicionEstado(estadoActual, nuevoEstado) {
        ...
        const transicionesValidas = {
            ...
            EN_PROCESO: ["PENDIENTE", "LISTO_PARA_RETIRAR", "LISTO", "ENTREGADO", "CANCELADO"],
            LISTO_PARA_RETIRAR: ["PENDIENTE", "EN_PROCESO", "LISTO", "ENTREGADO", "CANCELADO"],
            LISTO: ["PENDIENTE", "EN_PROCESO", "LISTO_PARA_RETIRAR", "ENTREGADO", "CANCELADO"],
            ENTREGADO: ["LISTO_PARA_RETIRAR", "LISTO", "EN_PROCESO", "PENDIENTE", "CANCELADO"],
            CANCELADO: ["PENDIENTE", "EN_PROCESO", "LISTO", "LISTO_PARA_RETIRAR"]
        };
