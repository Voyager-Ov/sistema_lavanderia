...
export default function EditarClientePosPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      router.push(`/pos/clientes/${clienteId}`)
    } catch (error: any) {
  ...
  if (!cliente) {
    return (
      <div className="flex-1 flex flex-col items-center justify-center h-full p-8 text-center">
        ...
        <Button onClick={() => router.push("/pos/clientes")} className="mt-6 rounded-full">
          Volver al listado
        </Button>
      </div>
    )
  ...
  return (
    <div ref={containerRef} className="flex-1 flex flex-col min-h-full bg-gray-50/40">
      ...
      <div className="fade-in-up flex items-center gap-4 px-4 sm:px-8 pt-6 pb-4 bg-white border-b border-gray-100">
        <button
          onClick={() => router.push(`/pos/clientes/${clienteId}`)}
      ...
      <div className="flex-1 flex items-start justify-center p-4 sm:p-8">
        <div className="w-full max-w-xl">
          ...
          <div className="fade-in-up flex items-center gap-4 mb-8">
            <div className="w-16 h-16 bg-gradient-to-br from-brand-blue to-blue-500 text-white rounded-[1.5rem] flex items-center justify-center text-3xl font-black shadow-md shadow-blue-200/50">
