...
export default function PosPerfilPage() {
  ...
  return (
    <div className="flex-1 flex flex-col gap-8 animate-in fade-in slide-in-from-bottom-4 duration-500 p-4 lg:p-8 max-w-[1200px] mx-auto w-full">
      <div className="mb-2">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div className="rounded-2xl border border-neutral-200 bg-white shadow-md dark:border-neutral-800 dark:bg-neutral-900/50 p-6 md:p-8 space-y-6 flex flex-col">
          ...
          <div className="pt-6 flex justify-end">
            <Button className="font-bold rounded-xl px-6 bg-brand-blue hover:bg-blue-700 text-white" disabled>Guardar Datos</Button>
          </div>
        </div>
