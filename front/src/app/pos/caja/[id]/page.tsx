...
import { CajaDashboard } from "@/app/admin/caja/components/caja-dashboard"
import { Skeleton } from "@/shared/ui/feedback/skeleton"
import { ArrowLeft, Wallet } from "lucide-react"
import { Badge } from "@/shared/ui/data-display/badge"

export default function PosCajaDetallePage() {
  ...
  return (
    <div className="flex-1 flex flex-col h-full gap-6 max-w-[1600px] mx-auto w-full p-4 lg:p-8">
      {/* Header */}
      ...
      <div className="flex-1 flex flex-col mt-2">
        {isLoading ? (
          ...
          <div className="bg-white rounded-3xl border border-slate-100 shadow-sm p-12 text-center">
            ...
            <button
              onClick={() => router.push("/pos/caja")}
              className="mt-6 px-6 py-2.5 bg-brand-blue text-white rounded-xl font-medium hover:bg-blue-700 transition-colors"
            >
              Volver a Caja
            </button>
          </div>
