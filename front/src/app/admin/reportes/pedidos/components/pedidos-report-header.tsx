...
interface PedidosReportHeaderProps {
  fechaInicio: string
...
export function PedidosReportHeader({
  fechaInicio,
  setFechaInicio,
  fechaFin,
  setFechaFin,
  ...
  let filterText = "Filtrar por Fechas";
    ...
    <div className="fade-item flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-4">
      <div>
        ...
        <p className="text-gray-500 font-medium text-sm">
          Analiza el volumen de pedidos, estados, ingresos y rendimiento en el tiempo.
        </p>
      </div>
