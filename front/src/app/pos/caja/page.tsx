...
import { PosCajaHistorial } from "./components/pos-caja-historial"
...
import { AbrirCajaForm } from "@/app/admin/caja/components/abrir-caja-form"
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
              ...
              <div className="lg:col-span-7 flex flex-col gap-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  {/* Último cierre — monto */}
                  <div className="cursor-pointer" onClick={() => ultimaCaja && router.push(`/pos/caja/${ultimaCaja.id}`)}>
                    <KpiCard
                      title="Último Cierre"
