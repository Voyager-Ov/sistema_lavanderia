...
export function FinanzasHeader({
  ...
  return (
    <div className="fade-item flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
      <div>
        <h1 className="text-3xl font-black tracking-tight text-gray-900 mb-1">Finanzas</h1>
        <p className="text-gray-500 font-medium text-sm">Libro mayor, ingresos, egresos y analíticas del negocio.</p>
      </div>
      ...
      <div className="flex flex-col sm:flex-row gap-3 w-full md:w-auto">
        ...
        <div className="flex items-center gap-2">
          <Button 
            variant="outline" 
            className="rounded-full h-12 font-bold text-slate-700 bg-white border-2 border-slate-200 shadow-sm gap-2 whitespace-nowrap px-5 hover:bg-slate-50"
