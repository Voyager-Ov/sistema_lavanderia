...
import { Calendar as CalendarIcon, X, MinusCircle, Tags } from "lucide-react"
...
export function FinanzasHeader({
  ...
  return (
    <div className="fade-item flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
      <div>
        <h1 className="text-3xl font-black tracking-tight text-gray-900 dark:text-neutral-50 mb-1">Finanzas</h1>
        <p className="text-gray-500 dark:text-neutral-400 font-medium text-sm">Libro mayor, ingresos, egresos y analíticas del negocio.</p>
      </div>
      ...
      <div className="flex flex-col sm:flex-row gap-3 w-full md:w-auto">
        ...
        {/* Acciones movidas aquí */}
        <div className="flex items-center gap-2">
          <Button 
            variant="outline" 
            className="rounded-full h-12 font-bold text-slate-700 dark:text-neutral-200 bg-white dark:bg-neutral-800 border-2 border-slate-200 dark:border-neutral-700 shadow-sm gap-2 whitespace-nowrap px-5 hover:bg-slate-50 dark:hover:bg-neutral-700"
          ...
          <Button 
            className="rounded-full h-12 font-bold bg-rose-600 hover:bg-rose-700 text-white shadow-sm gap-2 whitespace-nowrap px-6"
            onClick={onOpenGasto}
          >
